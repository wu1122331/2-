...
public final class a {
    ...
    private static IvParameterSpec a(byte[] bArr) {
        try {
            return (IvParameterSpec) f.a(IvParameterSpec.class, new Object[]{bArr}, new Class[]{byte[].class});
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static byte[] a(String str, byte[] bArr) {
        ...
        cipher.init(1, secretKeySpec, a(substring.getBytes("utf-8")));
    ...
    public static byte[] b(String str, byte[] bArr) {
        ...
        SecretKeySpec secretKeySpec = new SecretKeySpec(c, "AES");
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
        cipher.init(2, secretKeySpec, a(substring.getBytes("utf-8")));
        return cipher.doFinal(bArr);
    }
